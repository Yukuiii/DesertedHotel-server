package com.yukuii.desertedhotel.auth.utils;
...
public class CaptchaUtils {
    ...
    public String getCaptchaCode(String captchaId) {
        if(redisTemplate.opsForValue().get("captcha:" + captchaId) == null){
            return null;
        }
        return redisTemplate.opsForValue().get("captcha:" + captchaId);
    }
}